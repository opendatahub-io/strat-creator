...
def reconstruct_business_need(description_md, rfe_md):
    ...
    """
    if RFE_REFERENCE_MARKER in description_md and not rfe_md:
        print("  WARNING: description contains RFE reference marker but "
              "no RFE content available for reconstruction.",
              file=sys.stderr)
        return description_md
    if RFE_REFERENCE_MARKER not in description_md:
        return description_md
