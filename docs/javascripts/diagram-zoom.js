...
(function () {
  ...
  function addControls(div) {
    ...
    bar.innerHTML =
      '<button type="button" data-action="zoom-in" aria-label="Zoom in diagram" title="Zoom in">&#43;</button>' +
      '<button type="button" data-action="zoom-out" aria-label="Zoom out diagram" title="Zoom out">&#8722;</button>' +
      '<button type="button" data-action="reset" aria-label="Reset diagram zoom" title="Reset zoom">1:1</button>' +
      '<button type="button" data-action="fullscreen" aria-label="Open diagram in fullscreen" title="View full screen">&#9974;</button>';
    wrapper.after(bar);
  }
  ...
  function openFullscreen(mermaidDiv) {
    ...
    toolbar.innerHTML =
      '<button type="button" data-action="ol-zoom-in" aria-label="Zoom in diagram" title="Zoom in">&#43;</button>' +
      '<button type="button" data-action="ol-zoom-out" aria-label="Zoom out diagram" title="Zoom out">&#8722;</button>' +
      '<button type="button" data-action="ol-reset" aria-label="Reset diagram zoom" title="Reset">1:1</button>' +
      '<button type="button" data-action="ol-close" aria-label="Close fullscreen diagram" title="Close">&#10005;</button>';
